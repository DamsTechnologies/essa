        ...
        <div className="bg-card rounded-2xl shadow-premium p-6 border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {top3.map((contestant, index) => (
              <div
                key={contestant.id}
                className={`flex items-center gap-4 p-4 rounded-xl border-2 transition-all duration-300 ${rankColors[index]}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-foreground truncate">{contestant.name}</p>
